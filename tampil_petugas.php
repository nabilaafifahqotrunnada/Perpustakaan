...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <a href="../userPetugas.php" class="navbar-brand" style="font-family:blockletter;">Admin</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                ...
                <a href="tampil_petugas.php" class="nav-item nav-link">Profile</a>
                <a href="#" class="nav-item nav-link">Petugas</a>
            </div>
            <form class="form-inline ml-auto">
                <div class="navbar-nav">
                    <a href="../logoutPetugas.php" class="nav-item nav-link active">Logout</a>
                </div>
            </form>
        </div>
    </nav>
